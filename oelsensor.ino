...
uint16_t OilTempCompValues[]            ={Old_sensor_Temperature_30,Old_sensor_Temperature_40,Old_sensor_Temperature_50,Old_sensor_Temperature_55,Old_sensor_Temperature_60,Old_sensor_Temperature_65,Old_sensor_Temperature_70,Old_sensor_Temperature_75,Old_sensor_Temperature_80,Old_sensor_Temperature_85,Old_sensor_Temperature_90,Old_sensor_Temperature_95,Old_sensor_Temperature_100,Old_sensor_Temperature_105,Old_sensor_Temperature_110,Old_sensor_Temperature_115};
uint16_t OilLevelCompValues[]           ={Old_sensor_OilLevelEmpty,Old_sensor_OilLevel_10,Old_sensor_OilLevel_20,Old_sensor_OilLevel_30,Old_sensor_OilLevel_40,Old_sensor_OilLevel_50,Old_sensor_OilLevel_60,Old_sensor_OilLevel_70,Old_sensor_OilLevel_80,Old_sensor_OilLevel_90,Old_sensor_OilLevelFull};
  ...
  if(NewData == true){
    ...
    if (receive_BT_Array[0]==UDS_READ_DATA_BY_IDENTIFIER)
    {
      ...
      if((receive_BT_Array[1]==0x06) && (receive_BT_Array[2]==0x06))
      {
        ...
        uint8_t i = 0;
        uint8_t tempvar;
        for(i=0;i<sizeof(OilTempCompValues);i++)
        {
          tempvar = 
            /* As example testval =         500 == 0x01F4    */
            /* SerialBT.print(testval >> 8);         -> 0x01 */
            /* SerialBT.print(testval & 0xFF);       -> 0xF4 */
          tempvar = (OilTempCompValues[i] >> 8) ;
          SerialBT.print(tempvar);
          tempvar = (OilTempCompValues[i] & 0xFF);
          SerialBT.print(tempvar);
        }                 
      ...
      if((receive_BT_Array[1]==0x06) && (receive_BT_Array[2]==0x07))
      {
        ...
        uint8_t i = 0;
        uint8_t tempvar;
        for(i=0;i<sizeof(OilLevelCompValues);i++)
        {
          tempvar = 
            /* As example testval =         500 == 0x01F4    */
            /* SerialBT.print(testval >> 8);         -> 0x01 */
            /* SerialBT.print(testval & 0xFF);       -> 0xF4 */
          tempvar = (OilLevelCompValues[i] >> 8) ;
          SerialBT.print(tempvar);
          tempvar = (OilLevelCompValues[i] & 0xFF);
          SerialBT.print(tempvar);
        } 
    ...
    if(receive_BT_Array[0] == UDS_WRITE_DATA_BY_IDENTIFIER)
    {
      ...
      if((receive_BT_Array[1]==0x06) && (receive_BT_Array[2]==0x06))
      {
        ...
        temp = ((uint16_t) receive_BT_Array[25])|receive_BT_Array[26];
        preferences.putShort("Old_sensor_Temperature_95",temp);
        temp = ((uint16_t) receive_BT_Array[27])|receive_BT_Array[28];
        preferences.putShort("Old_sensor_Temperature_100",temp);
        temp = ((uint16_t) receive_BT_Array[29])|receive_BT_Array[30];
        preferences.putShort("Old_sensor_Temperature_105",temp);
        temp = ((uint16_t) receive_BT_Array[31])|receive_BT_Array[32];
        preferences.putShort("Old_sensor_Temperature_110",temp);
        temp = ((uint16_t) receive_BT_Array[33])|receive_BT_Array[34];
       ...
       /* This part should set the compare values for Level
...
void readEepromValues()
{
  ...
  OilTempCompValues[0] = preferences.getUShort("Old_sensor_Temperature_30",Old_sensor_Temperature_30);
  OilTempCompValues[1] = preferences.getUShort("Old_sensor_Temperature_40",Old_sensor_Temperature_40);
  OilTempCompValues[2] = preferences.getUShort("Old_sensor_Temperature_50",Old_sensor_Temperature_50);
  OilTempCompValues[3] = preferences.getUShort("Old_sensor_Temperature_55",Old_sensor_Temperature_55);
  OilTempCompValues[4] = preferences.getUShort("Old_sensor_Temperature_60",Old_sensor_Temperature_60);
  OilTempCompValues[5] = preferences.getUShort("Old_sensor_Temperature_65",Old_sensor_Temperature_65);
  OilTempCompValues[6] = preferences.getUShort("Old_sensor_Temperature_70",Old_sensor_Temperature_70);
  OilTempCompValues[7] = preferences.getUShort("Old_sensor_Temperature_75",Old_sensor_Temperature_75);
  OilTempCompValues[8] = preferences.getUShort("Old_sensor_Temperature_80",Old_sensor_Temperature_80);
  OilTempCompValues[9] = preferences.getUShort("Old_sensor_Temperature_85",Old_sensor_Temperature_85);
  OilTempCompValues[10] = preferences.getUShort("Old_sensor_Temperature_90",Old_sensor_Temperature_90);
  OilTempCompValues[11] = preferences.getUShort("Old_sensor_Temperature_95",Old_sensor_Temperature_95);
  OilTempCompValues[12] = preferences.getUShort("Old_sensor_Temperature_100",Old_sensor_Temperature_100);
  OilTempCompValues[13] = preferences.getUShort("Old_sensor_Temperature_105",Old_sensor_Temperature_105);
  OilTempCompValues[14] = preferences.getUShort("Old_sensor_Temperature_110",Old_sensor_Temperature_110);
  OilTempCompValues[15] = preferences.getUShort("Old_sensor_Temperature_115",Old_sensor_Temperature_115);

  OilLevelCompValues[0] = preferences.getUShort("Old_sensor_OilLevelEmpty",Old_sensor_OilLevelEmpty);
  OilLevelCompValues[1] = preferences.getUShort("Old_sensor_OilLevel_10",Old_sensor_OilLevel_10);
  OilLevelCompValues[2] = preferences.getUShort("Old_sensor_OilLevel_20",Old_sensor_OilLevel_20);
  OilLevelCompValues[3] = preferences.getUShort("Old_sensor_OilLevel_30",Old_sensor_OilLevel_30);
  OilLevelCompValues[4] = preferences.getUShort("Old_sensor_OilLevel_40",Old_sensor_OilLevel_40);
  OilLevelCompValues[5] = preferences.getUShort("Old_sensor_OilLevel_50",Old_sensor_OilLevel_50);
  OilLevelCompValues[6] = preferences.getUShort("Old_sensor_OilLevel_60",Old_sensor_OilLevel_60);
  OilLevelCompValues[7] = preferences.getUShort("Old_sensor_OilLevel_70",Old_sensor_OilLevel_70);
  OilLevelCompValues[8] = preferences.getUShort("Old_sensor_OilLevel_80",Old_sensor_OilLevel_80);
  OilLevelCompValues[9] = preferences.getUShort("Old_sensor_OilLevel_90",Old_sensor_OilLevel_90);
  OilLevelCompValues[10] = preferences.getUShort("Old_sensor_OilLevelFull",Old_sensor_OilLevelFull);
